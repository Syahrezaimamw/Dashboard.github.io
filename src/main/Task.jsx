...
export const Task = () => {
    const colorStyles = {
        control: (styles, state) => ({
            ...styles, zIndex: 99, backgroundColor: 'rgb(245,245,245)', border: '0px', borderBottom: '2px solid #d1d5db', borderRadius: 'none'
        }),
                        ...
                        <div className='flex gap-1'>
                            <>
                                ...
                                <button
                                    ...
                                    className="flex justify-center px-4 py-2 text-white transition-all duration-300 bg-hitam rounded-xl active:scale-95 "
                                    ...
                                    {load ?
                                        <span className='flex items-center'>
                                            ...
                                            <svg
                                                aria-hidden="true"
                                                role="status"
                                                className="inline w-4 h-4 mt-1 text-white md:mt-0 animate-spin"
                                                viewBox="0 0 100 101"
                                                fill="none"
                                            ...
                                            <span className='hidden md:flex sm:ms-3 '  >
                            ...
                            <button className='px-4 py-2 bg-[rgb(235,235,235)] rounded-xl active:scale-95' onClick={(e)=>reset(e)}>Reset</button>
                        </div>
